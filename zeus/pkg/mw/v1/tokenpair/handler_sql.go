...
func (h *sqlHandler) baseKeys() error {
	...
	if h.TokenTwoID != nil {
		strBytes, err := json.Marshal(*h.TokenTwoID)
		if err != nil {
			return err
		}
		h.baseVals[tokenpair.FieldTokenTwoID] = string(strBytes)
		h.BondTokenTwoID = h.TokenTwoID
	}
	...
	if h.BondTokenTwoID == nil {
		return fmt.Errorf("please give tokentwoid")
	}
	strBytes, err = json.Marshal(*h.BondTokenTwoID)
	if err != nil {
		return err
	}
	h.bondVals[tokenpair.FieldTokenTwoID] = string(strBytes)
	return nil
}
