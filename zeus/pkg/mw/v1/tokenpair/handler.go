...
func WithTokenOneID(id *uint32, must bool) func(context.Context, *Handler) error {
	return func(ctx context.Context, h *Handler) error {
		if id == nil {
			if must {
				return fmt.Errorf("invalid tokenoneid1")
			}
			return nil
		}
		...
		if !exist {
			return fmt.Errorf("invalid tokenoneid2")
		}
...
func WithTokenTwoID(id *uint32, must bool) func(context.Context, *Handler) error {
	return func(ctx context.Context, h *Handler) error {
		if id == nil {
			if must {
				return fmt.Errorf("invalid tokentwoid")
			}
			return nil
		}
		tokenH, err := token.NewHandler(ctx, token.WithID(id, true))
...
func WithConds(conds *tokenpairproto.Conds) func(context.Context, *Handler) error {
	return func(ctx context.Context, h *Handler) error {
		...
		if conds.TokenTwoID != nil {
			h.Conds.TokenTwoID = &cruder.Cond{
				Op:  conds.GetTokenTwoID().GetOp(),
				Val: conds.GetTokenTwoID().GetValue(),
			}
		}
		if conds.Remark != nil {
