...
func (ku *KPriceUpdate) SetTime(u uint32) *KPriceUpdate {
	ku.mutation.ResetTime()
	ku.mutation.SetTime(u)
	return ku
}

// AddTime adds u to the "time" field.
func (ku *KPriceUpdate) AddTime(u int32) *KPriceUpdate {
	ku.mutation.AddTime(u)
	return ku
}
...
func (ku *KPriceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ku.mutation.Time(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
	...
	if value, ok := ku.mutation.AddedTime(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: kprice.FieldTime,
...
// SetTime sets the "time" field.
func (kuo *KPriceUpdateOne) SetTime(u uint32) *KPriceUpdateOne {
	kuo.mutation.ResetTime()
	kuo.mutation.SetTime(u)
	return kuo
}

// AddTime adds u to the "time" field.
func (kuo *KPriceUpdateOne) AddTime(u int32) *KPriceUpdateOne {
	kuo.mutation.AddTime(u)
	return kuo
}
...
func (kuo *KPriceUpdateOne) sqlSave(ctx context.Context) (_node *KPrice, err error) {
	...
	if value, ok := kuo.mutation.Time(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: kprice.FieldTime,
	...
	if value, ok := kuo.mutation.AddedTime(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: kprice.FieldTime,
