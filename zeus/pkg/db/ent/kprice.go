...
func (*KPrice) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case kprice.FieldID, kprice.FieldCreatedAt, kprice.FieldUpdatedAt, kprice.FieldDeletedAt, kprice.FieldTokenPairID, kprice.FieldTime:
...
func (k *KPrice) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", k.Time))
	builder.WriteByte(')')
