...
// TokenTwoID applies equality check predicate on the "token_two_id" field. It's identical to TokenTwoIDEQ.
func TokenTwoID(v uint32) predicate.TokenPair {
	return predicate.TokenPair(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTokenTwoID), v))
	})
}
...
// TokenTwoIDEQ applies the EQ predicate on the "token_two_id" field.
func TokenTwoIDEQ(v uint32) predicate.TokenPair {
	return predicate.TokenPair(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTokenTwoID), v))
	})
}

// TokenTwoIDNEQ applies the NEQ predicate on the "token_two_id" field.
func TokenTwoIDNEQ(v uint32) predicate.TokenPair {
	return predicate.TokenPair(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldTokenTwoID), v))
	})
}

// TokenTwoIDIn applies the In predicate on the "token_two_id" field.
func TokenTwoIDIn(vs ...uint32) predicate.TokenPair {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.TokenPair(func(s *sql.Selector) {
		s.Where(sql.In(s.C(FieldTokenTwoID), v...))
	})
}

// TokenTwoIDNotIn applies the NotIn predicate on the "token_two_id" field.
func TokenTwoIDNotIn(vs ...uint32) predicate.TokenPair {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.TokenPair(func(s *sql.Selector) {
		s.Where(sql.NotIn(s.C(FieldTokenTwoID), v...))
	})
}

// TokenTwoIDGT applies the GT predicate on the "token_two_id" field.
func TokenTwoIDGT(v uint32) predicate.TokenPair {
	return predicate.TokenPair(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldTokenTwoID), v))
	})
}

// TokenTwoIDGTE applies the GTE predicate on the "token_two_id" field.
func TokenTwoIDGTE(v uint32) predicate.TokenPair {
	return predicate.TokenPair(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldTokenTwoID), v))
	})
}

// TokenTwoIDLT applies the LT predicate on the "token_two_id" field.
func TokenTwoIDLT(v uint32) predicate.TokenPair {
	return predicate.TokenPair(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldTokenTwoID), v))
	})
}

// TokenTwoIDLTE applies the LTE predicate on the "token_two_id" field.
func TokenTwoIDLTE(v uint32) predicate.TokenPair {
	return predicate.TokenPair(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldTokenTwoID), v))
	})
}
