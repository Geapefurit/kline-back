...
func Time(v uint32) predicate.KPrice {
	return predicate.KPrice(func(s *sql.Selector) {
...
func TimeEQ(v uint32) predicate.KPrice {
	return predicate.KPrice(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTime), v))
	})
}
...
func TimeNEQ(v uint32) predicate.KPrice {
	return predicate.KPrice(func(s *sql.Selector) {
...
func TimeIn(vs ...uint32) predicate.KPrice {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TimeNotIn(vs ...uint32) predicate.KPrice {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TimeGT(v uint32) predicate.KPrice {
	return predicate.KPrice(func(s *sql.Selector) {
...
func TimeGTE(v uint32) predicate.KPrice {
	return predicate.KPrice(func(s *sql.Selector) {
...
func TimeLT(v uint32) predicate.KPrice {
	return predicate.KPrice(func(s *sql.Selector) {
...
func TimeLTE(v uint32) predicate.KPrice {
	return predicate.KPrice(func(s *sql.Selector) {
