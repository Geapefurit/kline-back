...
func (tpu *TokenPairUpdate) SetTokenTwoID(u uint32) *TokenPairUpdate {
	tpu.mutation.ResetTokenTwoID()
	tpu.mutation.SetTokenTwoID(u)
	return tpu
}

// AddTokenTwoID adds u to the "token_two_id" field.
func (tpu *TokenPairUpdate) AddTokenTwoID(u int32) *TokenPairUpdate {
	tpu.mutation.AddTokenTwoID(u)
	return tpu
}
...
func (tpu *TokenPairUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tpu.mutation.TokenTwoID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
	...
	if value, ok := tpu.mutation.AddedTokenTwoID(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: tokenpair.FieldTokenTwoID,
...
// SetTokenTwoID sets the "token_two_id" field.
func (tpuo *TokenPairUpdateOne) SetTokenTwoID(u uint32) *TokenPairUpdateOne {
	tpuo.mutation.ResetTokenTwoID()
	tpuo.mutation.SetTokenTwoID(u)
	return tpuo
}

// AddTokenTwoID adds u to the "token_two_id" field.
func (tpuo *TokenPairUpdateOne) AddTokenTwoID(u int32) *TokenPairUpdateOne {
	tpuo.mutation.AddTokenTwoID(u)
	return tpuo
}
...
func (tpuo *TokenPairUpdateOne) sqlSave(ctx context.Context) (_node *TokenPair, err error) {
	...
	if value, ok := tpuo.mutation.TokenTwoID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: tokenpair.FieldTokenTwoID,
	...
	if value, ok := tpuo.mutation.AddedTokenTwoID(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: tokenpair.FieldTokenTwoID,
