...
func (kc *KPriceCreate) SetTime(u uint32) *KPriceCreate {
	kc.mutation.SetTime(u)
	return kc
}
...
func (kc *KPriceCreate) check() error {
	...
	if _, ok := kc.mutation.Time(); !ok {
		return &ValidationError{Name: "time", err: errors.New(`ent: missing required field "KPrice.time"`)}
	}
	return nil
}
...
func (kc *KPriceCreate) createSpec() (*KPrice, *sqlgraph.CreateSpec) {
	...
	if value, ok := kc.mutation.Time(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: kprice.FieldTime,
		})
		_node.Time = value
	}
	return _node, _spec
...
// SetTime sets the "time" field.
func (u *KPriceUpsert) SetTime(v uint32) *KPriceUpsert {
	u.Set(kprice.FieldTime, v)
	return u
}

// UpdateTime sets the "time" field to the value that was provided on create.
func (u *KPriceUpsert) UpdateTime() *KPriceUpsert {
	u.SetExcluded(kprice.FieldTime)
	return u
}

// AddTime adds v to the "time" field.
func (u *KPriceUpsert) AddTime(v uint32) *KPriceUpsert {
	u.Add(kprice.FieldTime, v)
	return u
}
...
// SetTime sets the "time" field.
func (u *KPriceUpsertOne) SetTime(v uint32) *KPriceUpsertOne {
	return u.Update(func(s *KPriceUpsert) {
		s.SetTime(v)
	})
}
...
// AddTime adds v to the "time" field.
func (u *KPriceUpsertOne) AddTime(v uint32) *KPriceUpsertOne {
	return u.Update(func(s *KPriceUpsert) {
		s.AddTime(v)
	})
}
...
// UpdateTime sets the "time" field to the value that was provided on create.
func (u *KPriceUpsertOne) UpdateTime() *KPriceUpsertOne {
	return u.Update(func(s *KPriceUpsert) {
		s.UpdateTime()
	})
}
...
// SetTime sets the "time" field.
func (u *KPriceUpsertBulk) SetTime(v uint32) *KPriceUpsertBulk {
	return u.Update(func(s *KPriceUpsert) {
		s.SetTime(v)
	})
}
...
// AddTime adds v to the "time" field.
func (u *KPriceUpsertBulk) AddTime(v uint32) *KPriceUpsertBulk {
	return u.Update(func(s *KPriceUpsert) {
		s.AddTime(v)
	})
}
...
// UpdateTime sets the "time" field to the value that was provided on create.
func (u *KPriceUpsertBulk) UpdateTime() *KPriceUpsertBulk {
	return u.Update(func(s *KPriceUpsert) {
		s.UpdateTime()
	})
}
